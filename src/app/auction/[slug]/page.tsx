...
import { Player, sets } from '@/lib/player-data';
          ...
          <Card>
            <CardHeader>
                <div className="flex items-center justify-between">
                    <div>
                        <CardTitle className="text-3xl font-headline">Auction Room: Set {set.id}</CardTitle>
            ...
            <CardContent className="flex flex-col items-center justify-center min-h-[400px] text-center">
              {isAuctionFinished ? (
                 <div className="flex flex-col items-center gap-4 text-center">
                    ...
                    <p className="text-muted-foreground">All players in Set {set.id} have been auctioned.</p>
                     <Button asChild>
               ...
               <Button onClick={drawPlayer} disabled={remainingPlayers.length === 0} size="lg" className="mt-8">
                 <Gavel className="mr-2" />
                 {drawnPlayer ? 'Draw Next Player' : 'Draw First Player'}
               </Button>
